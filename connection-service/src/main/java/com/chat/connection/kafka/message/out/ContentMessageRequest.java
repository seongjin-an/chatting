...
@Builder
public record ContentMessageRequest(String senderId, String senderName, Long channelId, String content, String instanceId) implements
    KafkaMessage {

    public static ContentMessageRequest of(UserId senderId, String senderName, ContentPayload payload, String instanceId) {
        return new ContentMessageRequest(senderId.id(), senderName, payload.channelId(), payload.content(), instanceId);
    }
}
